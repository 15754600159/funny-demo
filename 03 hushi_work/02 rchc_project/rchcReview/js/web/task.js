...
function DelData(id,dom) {
	...
	$.ajax({
		type: "delete",
		url: "http://10.101.139.21:8778/bjhc/task/info/delete/" + id + '/' + userId,
		async: true,
...
function Search() {
	$('#chaxun').on('click',function () {
		...
		$.ajax({
			type:"post",
			url:"http://10.101.139.21:8778/bjhc/task/info/name",
			data:{
				userId: userId,
				name: taskInput
			},
...
function getScData() {
	...
	$.ajax({
		type: "get",
		url: "http://10.101.139.21:8778/bjhc/task/info/get/"+userId,
		async: true,
		success: function(data) {
			console.log(data)
...
function Load(jobid,seq,finish) {
	...
	if(finish == 1) {
		...
		$.ajax({
			type:"get",
			url:"http://10.101.139.21:8778/bjhc/task/info/load/"+jobid+'/'+seq,
			async:true,
			success: function (data) {
				console.log(data)
