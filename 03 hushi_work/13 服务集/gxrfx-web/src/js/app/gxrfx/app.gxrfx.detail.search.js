 ...
 * @Last Modified time: 2018-02-08 20:08:26
 */
app.gxrfx.detail.search = {
    pageContainer: '.gxrfx-detail',
    url: 'pages/gxrfx/detail.html',
    ...
    initSearchForm: async function(pageNo, pageSize, pagination) {
        const that = app.gxrfx.detail.search;  //因为要将initSearchForm函数传入pagination中执行，所以that要指向具体的对象，不能用this
