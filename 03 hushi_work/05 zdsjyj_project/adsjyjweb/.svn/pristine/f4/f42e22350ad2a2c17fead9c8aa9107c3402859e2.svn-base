            ...
            success: function(result) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    $("#qtrygl_table").append(
                        ...
                        "<td>" + data[i].ggFlag + "</td>" +
                        "<td>" +
                        '<button class="btn btn-sm btn-primary" type="submit" onclick="app.gzqt.toqtryViewPage(\'' + data[i].id + '\')">查看</button>' +
                        '<button class="btn btn-sm btn-primary" type="submit" style="margin-left:10px;" onclick="app.gzqt.toqtryUpdatePage(\'' + data[i].id + '\')">修改</button>' +
                        '<button class="btn btn-sm btn-primary" type="submit" style="margin-left:10px;" onclick="app.gzqt.gzqtrydel.delone(\'' + data[i].id + '\')">删除</button>' +
                        "</td>" +
                        "</tr >"
                    );
                }
