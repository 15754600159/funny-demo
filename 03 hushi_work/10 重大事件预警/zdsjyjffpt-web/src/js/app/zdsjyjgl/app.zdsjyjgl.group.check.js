app.zdsjyjgl.group.check = {
	pageContainer: '.group-check',
	url: 'pages/zdsjyjgl/groupCheckWindow.html',
	open: function() {
	...
	initForm: function() {
        ...
        const that = this,
            id = $(app.zdsjyjgl.group.pageContainer).data('check-id'); //读取查看的模型id
        $(app.zdsjyjgl.group.pageContainer).data('check-id', ''); //清除查看的模型id数据
        app.api.zdsjyjgl.checkGroupById({
            id: id,
