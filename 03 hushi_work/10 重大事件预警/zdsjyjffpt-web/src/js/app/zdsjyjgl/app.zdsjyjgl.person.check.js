app.zdsjyjgl.person.check = {
	pageContainer: '.person-check',
	url: 'pages/zdsjyjgl/personCheckWindow.html',
	open: function() {
	...
	initForm: function() {
        ...
        const that = this,
            id = $(app.zdsjyjgl.person.pageContainer).data('check-id'); //读取查看的模型id
        $(app.zdsjyjgl.person.pageContainer).data('check-id', ''); //清除查看的模型id数据
        app.api.zdsjyjgl.checkPersonById({
            id: id,
