			...
			success: function(result) {
				...
				for (var i = 0; i < data.length; i++) {
					...
					$(".table_all").append(
						...
						"<td>" + 40 + "</td>" +
						"<td>" +
						'<button class="btn btn-sm btn-primary" type="submit" onclick="app.gzqt.toqtryglViewPage(\'' + data[i].zdqtbh +
						'\');">人员</button>' +
						'<button class="btn btn-sm btn-primary" type="submit" style="margin-left:10px;" onclick="app.gzqt.toqtrywgzglViewPage(\'' +
						data[i].zdqtbh + '\');">未关注人员</button>' +
						'<button class="btn btn-sm btn-primary" type="submit" style="margin-left:10px;" onclick="app.gzqt.toglzdrViewPage(\'' +
						data[i].zdqtbh + '\');">关联重点人</button>' +
						'<button class="btn btn-sm btn-info" type="submit" style="margin-left:10px;" onclick="app.gzqt.toViewPage(\'' +
						data[i].zdqtbh + '\');">查看</button>' +
						'<button class="btn btn-sm btn-info" type="submit" style="margin-left:10px;" onclick="app.gzqt.toUpdatePage(\'' +
						data[i].zdqtbh + '\');">修改</button>' +
						'<button class="btn btn-sm btn-info" type="submit" style="margin-left:10px;" onclick="app.gzqt.toxcxqtViewPage(\'' +
						data[i].zdqtbh + '\');">是否形成新群体</button>' +
						'<button class="btn btn-sm btn-info" type="submit" style="margin-left:10px;" onclick="app.gzqt.togjyjViewPage(\'' +
						data[i].zdqtbh + '\');">轨迹预警</button>' +
						// '<button class="btn btn-sm btn-info" type="submit" style="margin-left:10px;">异动预警</button>' +
						'<button class="btn btn-sm btn-danger" type="submit" style="margin-left:10px;" onclick="app.gzqt.delone(\'' +
						data[i].zdqtbh + '\')">删除</button>' +
						"</td>" +
						"</tr >"
					);
				}
