app.fxmxgl.qtwjgzpz.add = {
	url: 'pages/fxmxpz/qtwjgzpzAddWindow.html',
	callback: null,
	vehicles: null,
	open: function() {
	...
	initForm: function() {
		...
		app.select.init($('#form-rule-add-main select[name="ruleStatus"]'), mbObject.RULE_STATUS);
		app.select.init($('#form-rule-add-main select[name="ruleHuji"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-add-main select[name="ruleMinzu"]'), mbObject.nation);
		app.select.init($('#form-rule-add-main select[name="ruleXingbie"]'), mbObject.sex);
		app.select.init($('#form-rule-add-main select[name="ruleXiaqu"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-add-main select[name="ruleRylb"]'), mbObject.tb_d_zdryxl);
		app.select.init($('#form-rule-add-main select[name="ruleHdcslx"]'), mbObject.RULE_TYPE);
		app.select.init($('#form-rule-add-main select[name="ruleCfd"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-add-main select[name="ruleMdd"]'), mbObject.tb_d_qgxzqh);
