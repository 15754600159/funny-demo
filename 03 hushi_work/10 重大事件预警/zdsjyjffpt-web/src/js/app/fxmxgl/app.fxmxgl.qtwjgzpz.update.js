app.fxmxgl.qtwjgzpz.update = {
	url: 'pages/fxmxpz/qtwjgzpzUpdateWindow.html',
	callback: null,
	vehicles: null,
	open: function(that) {
	...
	init: function() {
		...
		$('#btn-ok-rule-update').off('click').on('click', function() {
			var formData = $m('#form-rule-update-main').serializeObject(),
	...
	initForm: function() {
		...
		app.select.init($('#form-rule-update-main select[name="ruleStatus"]'), mbObject.RULE_STATUS);
		app.select.init($('#form-rule-update-main select[name="ruleHuji"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-update-main select[name="ruleMinzu"]'), mbObject.nation);
		app.select.init($('#form-rule-update-main select[name="ruleXingbie"]'), mbObject.sex);
		app.select.init($('#form-rule-update-main select[name="ruleXiaqu"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-update-main select[name="ruleRylb"]'), mbObject.tb_d_zdryxl);
		app.select.init($('#form-rule-update-main select[name="ruleHdcslx"]'), mbObject.RULE_TYPE);
		app.select.init($('#form-rule-update-main select[name="ruleCfd"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-update-main select[name="ruleMdd"]'), mbObject.tb_d_qgxzqh);
		...
		$.ajax({
			...
			success: function(response) {
				if (response.success === 1) {
					...
					$m('#form-rule-update-main').setFormValues(response.msg);
