app.fxmxgl.qtwjgzpz.check = {
	url: 'pages/fxmxpz/qtwjgzpzCheckWindow.html',
	callback: null,
	vehicles: null,
	open: function(that) {
	...
	initForm: function() {
		...
		app.select.init($('#form-rule-check-main select[name="ruleStatus"]'), mbObject.RULE_STATUS);
		app.select.init($('#form-rule-check-main select[name="ruleHuji"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-check-main select[name="ruleMinzu"]'), mbObject.nation);
		app.select.init($('#form-rule-check-main select[name="ruleXingbie"]'), mbObject.sex);
		app.select.init($('#form-rule-check-main select[name="ruleXiaqu"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-check-main select[name="ruleRylb"]'), mbObject.tb_d_zdryxl);
		app.select.init($('#form-rule-check-main select[name="ruleHdcslx"]'), mbObject.RULE_TYPE);
		app.select.init($('#form-rule-check-main select[name="ruleCfd"]'), mbObject.tb_d_qgxzqh);
		app.select.init($('#form-rule-check-main select[name="ruleMdd"]'), mbObject.tb_d_qgxzqh);
		...
		$.ajax({
			...
			success: function(response) {
				if (response.success === 1) {
					...
					$m('#form-rule-check-main').setFormValues(response.msg);
