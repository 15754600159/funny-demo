 ...
 * @Last Modified time: 2018-02-27 21:05:16
 */
app.myUil = {
	 ...
	 * @return undefined
	 */
    initTabPage: function(container = 'document') {
        $('.content-nav', container).on('click', '.content-nav-item', function() {
            const _this = $(this),
                page = _this.data('page');
            _this.addClass('active').siblings('.content-nav-item').removeClass('active');
            $('.content-tab .content-sub-item', container).filter(function(index) {
                return $(this).data('subpage') === page;
            }).addClass('active').siblings('.content-sub-item').removeClass('active');
        })
    },
