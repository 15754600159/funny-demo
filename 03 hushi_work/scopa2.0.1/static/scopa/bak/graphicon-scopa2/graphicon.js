define(function(require){
    $(function(){
    	...
    	/*---------- 图析图标展示 ----------*/
    	$ajax.ajax({
    		url: staticUrl + '/scopa/bak/graphicon/icomoon/demo.html',
    		async: false,
    		success: function(data){
    			...
    			$('.graphicon-entity,.graphicon-relation,.graphicon-event,.graphicon-relation-line').on('click', function(){
    	...
    	$('.glyph').each(function(){
    		...
    		graphIcon.push({
    			name: etype + '_' + $('span[class^=graphicon_]',$this).attr('class'),
