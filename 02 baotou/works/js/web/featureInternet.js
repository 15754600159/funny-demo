...
$(function(){
	...
	function loadPic(){
		...
		beginTime = "beginTime=" + $("#reservation").val().split(",")[0];
	 	...
	 	xzqhdmLev1 = "&xzqhdmLev1=" + $("#area").val()
...
function ajaxNationBar(){
	...
	Get("/code/mzAll", function(data){
		...
		Get("/personInternet/features/mz?"+beginTime+endTime, function(res){
...
function ajaxSex(){
	...
	Get("/personInternet/features/xb?"+beginTime+endTime+xzqhdmLev1, function(res){
		var x = [],y = [],map = {};
		$.each(res, function(k,v) {
			x.push(xb(k))
...
function ajaxNativePlace(){
	Get("/code/jgAll1", function(jgdm){
		sdCfg.jgdmSf = jgdm;
		Get("/personInternet/features/jgdm_sf?"+beginTime+endTime+xzqhdmLev1, function(res){
			var x = [],y = [];
			$.each(res, function(k,v) {
				x.push(jg_sf(k))
				y.push(v)
...
//ajaxAges();//初始化年龄
function ajaxAges(){
	Get("/personInternet/features/nl?"+beginTime+endTime+xzqhdmLev1, function(res){
		var x = [],y = [],map = {};
		$.each(res, function(k,v) {
...
function ajaxSwsd(){
		...
		Get("/personInternet/features/kssj?"+beginTime+endTime+xzqhdmLev1, function(res){
			var x = [],y = [],map = {};
