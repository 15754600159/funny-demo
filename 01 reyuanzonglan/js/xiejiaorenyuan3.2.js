...
function queryClickBind(){
    ...
    $('#query').off('click').on('click', function(){
        ...
        var data = {
            ...
            xjlb: $('#myDataXieJiao option:selected').text(),
            ...
            success: function(person){
                ...
                for(var i = 0; i<(person.total + 1); i++){
                    ...
                    htmlCode += `<tr class="page${page}">
                                    <td>${personGroup[i].xjlb?personGroup[i].xjlb:'-'}</td>
                                    ...
                                    <td>${personGroup[i].zdryxlmc?personGroup[i].zdryxlmc:'-'}</td>
                                    <td>${personGroup[i].zy?personGroup[i].zy:'-'}</td>
                                    <td>${personGroup[i].jzdz?personGroup[i].jzdz:'-'}</td>
                                </tr>`;
                }
