        ...
        $.ajax({
            ...
            success: function(person){
                ...
                for(var i = 0; i<(person.total + 1); i++){
                    ...
                    htmlCode += "<tr class='page${page}'>  <td>${personGroup[i].xm?personGroup[i].xm:'-'}</td> <td>${personGroup[i].cyzjdm?personGroup[i].cyzjdm:'-'}</td> <td>${personGroup[i].zjhm?personGroup[i].zjhm:'-'}</td> <td>${personGroup[i].xbdm?personGroup[i].xbdm:'-'}</td> <td>${personGroup[i].mz?personGroup[i].mz:'-'}</td> <td>${personGroup[i].jgmc_sf?personGroup[i].jgmc_sf:'-'}-${personGroup[i].jgmc_s?personGroup[i].jgmc_s:'-'}-${personGroup[i].jgmc_qx?personGroup[i].jgmc_qx:'-'}</td> <td>${personGroup[i].nl?personGroup[i].nl:'-'}</td> <td>${personGroup[i].zy?personGroup[i].zy:'-'}</td> <td>${personGroup[i].xlmc?personGroup[i].xlmc:'-'}</td>td>${personGroup[i].jlxmc?personGroup[i].jlxmc:'-'}</td> </tr>";
                }
