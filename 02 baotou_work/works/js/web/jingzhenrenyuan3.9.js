            ...
            $.each(data.result, function (index, item) {
                $("#tableBody").append(
						    ...
						    "<td>"+(item.nl==undefined?'':parseInt(item.nl))+"</td>"+
						   	"<td>"+(item.gmsfhm==undefined?'':item.gmsfhm)+"</td>"+
						    "<td>"+(item.jg_sf==undefined?'':item.jg_sf)+"</td>"+
						    "<td>"+(item.mzmc==undefined?'':item.mzmc)+"</td>"+
						    "<td>"+(item.xlmc==undefined?'':item.xlmc)+"</td>"+
						    "<td>"+(item.xzz_jlxmc==undefined?'':item.xzz_jlxmc)+"</td>"+
						    "<td>"+(item.zatdmc==undefined?'':item.zatdmc)+"</td>"+
						    "<td>"+(item.zy==undefined?'':item.zy)+"</td>"+
						    "<td>"+(zdryxl[item.zdryxl] == undefined ? '':zdryxl[item.zdryxl])+"</td>"+
						    "</tr>"
				);
